...
Toimet tämän saavuttamiseksi tehdään ketjumaisessa prosessissa.  

Tietoverkkohyökkäysissä tai vakoiluissa prosessi on kyseinen:  
1. Tiedustelu. Kohde havaitaan, tutkitaan ja valitaan käyttäen avoimia lähteitä, tiettyjä teknologioita tai sosiaalisia suhteita.  
...
6. Johda ja hallitse. Tyypillisesti isäntäkoneen on lähetettävä signaaleja ulospäin ohjauspalvelimelle C2-yhteyden muodostamiseksi.   
7. Tavoitteisiin liittyvät toimenpiteet. C2-yhteyden muodostamisen jälkeen todellinen operaation alku alkaa tästä. Eli esim. tiedon kerääminen ja siirtäminen.  
...
On tärkeää valmistella ennen tiedustelun aloitusta tarkistamalla tietokoneen ja verkon tiedot, jotta  
aikaa ei kulu hukkaan.  
Tiedustelun avulla saadaan suuresta datan määrästä löydettyä kohteita, joihin on kaikista helpoin hyökätä.  

Hyvässä tiedustelun menetelmässä porttiskannauksen jälkeen tehdään verkkopalvelujen arviointi.  
On mahdollista löytää useita verkkopalveluita, joita käyttää.  
Vasta lopussa tehdään haavoittovuuksien skannaus, sillä tämä vaihe tulee hälyttämään tunkeutumisen havaitsemisjärjestelmät.  

 
# KKO 2003:36  
Vuonna 1998 17-poika sai syytteen tietomurron yrityksestä  
hänen yrittäessä porttiskannata osuupankin tietojärjestelmään.  
Pojan porttiskannaus ei läpäissyt osuuskunnan tietojärjestelmän palomuuria.  
Syyttäjä vaati 110 000 markan vahingonkorvaukset.  
Lopullisessa tuomiossa syyllisen oli maksettava yhteensä 75 000 markkaa.  

On siis mahdollista syyllistyä tietomurron yrityksestä, vaikka et pääse järjestelmien sisälle.  
...
Ero edellisestä ovat kahden portin näkyvyys.  
Portit 22 ja 88 ovat auki ja niiden sovellusten nimet ja versiot ovat näkyvillä.  
![](Images/H1Ka1.png)  



## e) Ratkaise vapaavalintainen kone HackTheBoxista  
Tässä tehtävässä on tarkoitus kaapata lippu FTP:n avulla.  
Annettu kohde IP: 10.129.167.234
...
https://www.finlex.fi/fi/oikeuskaytanto/korkein-oikeus/ennakkopaatokset/2003/36#OT2_OT1  
