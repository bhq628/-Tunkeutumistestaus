...
Tähän suunnitelmaan kuuluu kaikki tavoitteet, kuten liput ja miten niihin edetään. Testeissä esiintyy aina riskejä puolustavien laitteille ja niiden tiedoille ja red tiimin on sisällytettävä suunnitelmassaan näiden riskien hallinta. Testisuunnitelmassa on myös oltava ajoitukset skenaarioille, eskalaation menettelytavoista.  (TIBER-FI 2.0, kohta 5.4.1)  
