...
TLPT (Threat-Led Penetration Testing) on myös osana DORA asetusta. TLPT on kehittynein tunkeutumistestausmenetelmä tullessaan voimaan 2025. Vaativuustasoltaan organisoidun rikollisuuden ja kansallisvaltion toiminnan tasoista testausta.  
(Buuri 2026)  
...
Portin 514 kohdalla on RSH (remote shell) ja tämän deamon on Netkitillä päällä ja kuuntelee.  
RSH on 80 luvulla luotu teknologia, jonka SSH on korvannut.  
Se on työkalu, jonka avulla voidaan suorittaa komentoja etänä.  
RSH käyttää .rhosts-tiedostoja ja /etc/hosts.equiv-tiedostoa tunnistautumiseen. Nämä menetelmät perustuivat IP-osoitteisiin ja DNS:ään.  
IP osoitteiden väärentäminen on helppoa ja vielä sitä enemmän hyökkääjän ollessa samassa lähiverkossa.  
(SSH 2026a)  


Portin 2121 kohdalla on ftp. ftp:n avulla on mahdollista siirtää tiedostoja koneelta toiselle.  
FTP:tä ei suunniteltu turvalliseksi. Kaikki salasanat ja tiedot siirretään salaamattomana.  
Tässä ftp versio ei ole salattu, jonka avulla liikenteen kuuntelu olisi helppoa.  
(SSH 2026b)  
...
SSH 2026a: https://www.ssh.com/academy/ssh/rsh  
SSH 2026b: https://www.ssh.com/academy/ssh/ftp  
